...
export default function ProfileInfo() {
  return (
    ...
    >
      <div
        className="m-5 card text-center border-top-0 bg-light"
        style={{ width: "18rem" }}
      >
        <ProfileCard />
        <ul className="list-group list-group-flush mt-3 border-0 bg-light m-3">
          <li className="list-group-item border-0 bg-light d-flex align-items-center">
            <FaCalendarAlt style={{ fontSize: "1rem", marginRight: "1rem" }} />
            <span>April 02, 2004</span>
          </li>
          <li className="list-group-item border-0 bg-light d-flex align-items-center">
            <FaMapMarkerAlt style={{ fontSize: "1rem", marginRight: "1rem" }} />
            <span>Karachi, Pakistan</span>
          </li>
          <li className="list-group-item border-0 bg-light d-flex align-items-center">
            <FaEnvelope style={{ fontSize: "1rem", marginRight: "1rem" }} />
            <span>touseef@mail.com</span>
          </li>
          <li className="list-group-item border-0 bg-light d-flex align-items-center ">
            <FaMobileAlt style={{ fontSize: "1rem", marginRight: "1rem" }} />
            <span className="me-3">+92-3173098212</span>
          </li>
          <li className="list-group-item border-0 bg-light d-flex align-items-center">
            <FaSkype style={{ fontSize: "1rem", marginRight: "1rem" }} />
            <span>touseefahmed66</span>
          </li>
        </ul>
        ...
        <a
          ...
          style={{ maxWidth: "200px", marginLeft: "15%" }}
        >
